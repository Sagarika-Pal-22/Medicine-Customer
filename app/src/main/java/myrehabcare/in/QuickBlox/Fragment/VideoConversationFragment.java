...
import myrehabcare.in.QuickBlox.Adapter.OpponentsFromCallAdapter;
...
public class VideoConversationFragment extends BaseConversationFragment implements Serializable,
    ...
    protected void initViews(View view) {
        ...
        cameraToggle.setChecked(SharedPrefsHelper.getInstance(getContext()).get(CAMERA_ENABLED, true));
        ...
        isCurrentCameraFront = SharedPrefsHelper.getInstance(getContext()).get(IS_CURRENT_CAMERA_FRONT, true);
    ...
    protected void initButtonsListener() {
        ...
        cameraToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPrefsHelper.getInstance(getContext()).save(CAMERA_ENABLED, isChecked);
        ...
        if (conversationFragmentCallback != null) {
            conversationFragmentCallback.onSwitchCamera(new CameraVideoCapturer.CameraSwitchHandler() {
                ...
                public void onCameraSwitchDone(boolean b) {
                    ...
                    SharedPrefsHelper.getInstance(getContext()).save(IS_CURRENT_CAMERA_FRONT, b);
                    if (item != null) {
