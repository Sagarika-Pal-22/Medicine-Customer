package myrehabcare.in.QuickBlox.Service;
...
import myrehabcare.in.QuickBlox.QuickBloxUtils.NetworkConnectionChecker;
import myrehabcare.in.QuickBlox.QuickBloxUtils.RingtonePlayer;
...
import static myrehabcare.in.QuickBlox.QuickBloxUtils.Consts.MAX_OPPONENTS_COUNT;
...
public class CallService extends Service {
    ...
    public void clearButtonsState() {
        SharedPrefsHelper.getInstance(this).delete(BaseConversationFragment.MIC_ENABLED);
        SharedPrefsHelper.getInstance(this).delete(AudioConversationFragment.SPEAKER_ENABLED);
        SharedPrefsHelper.getInstance(this).delete(VideoConversationFragment.CAMERA_ENABLED);
        SharedPrefsHelper.getInstance(this).delete(VideoConversationFragment.IS_CURRENT_CAMERA_FRONT);
    }

    public void clearCallState() {
        SharedPrefsHelper.getInstance(this).delete(Consts.EXTRA_IS_INCOMING_CALL);
    }
