package myrehabcare.in.QuickBlox.Activity;
...
import myrehabcare.in.QuickBlox.Fragment.AudioConversationFragment;
import myrehabcare.in.QuickBlox.Fragment.BaseConversationFragment;
import myrehabcare.in.QuickBlox.Fragment.ConversationFragmentCallback;
import myrehabcare.in.QuickBlox.Fragment.IncomeCallFragment;
import myrehabcare.in.QuickBlox.Fragment.ScreenShareFragment;
import myrehabcare.in.QuickBlox.Fragment.VideoConversationFragment;
import myrehabcare.in.QuickBlox.QuickBloxUtils.Consts;
import myrehabcare.in.QuickBlox.QuickBloxUtils.ErrorUtils;
import myrehabcare.in.QuickBlox.QuickBloxUtils.FragmentExecuotr;
import myrehabcare.in.QuickBlox.QuickBloxUtils.IncomeCallFragmentCallbackListener;
import myrehabcare.in.QuickBlox.QuickBloxUtils.PermissionsChecker;
import myrehabcare.in.QuickBlox.QuickBloxUtils.SettingsUtil;
...
import myrehabcare.in.QuickBlox.QuickBloxUtils.UsersUtils;
...
import myrehabcare.in.QuickBlox.db.QbUsersDbManager;
...
public class CallActivity  extends BaseActivity implements IncomeCallFragmentCallbackListener,
    ...
    public static void start(Context context, boolean isIncomingCall) {
        ...
        SharedPrefsHelper.getInstance(context).save(Consts.EXTRA_IS_INCOMING_CALL, isIncomingCall);
    ...
    private void initScreen() {
        ...
        Config.isVideoCall=isVideoCall;
    ...
    private void checkPermission() {
        boolean cam = SharedPrefsHelper.getInstance(this).get(Consts.PERMISSIONS[0], true);
        boolean mic = SharedPrefsHelper.getInstance(this).get(Consts.PERMISSIONS[1], true);
    ...
    private void startLoadAbsentUsers() {
        ...
        if (!idsUsersNeedLoad.isEmpty()) {
            loadUsersByIds(idsUsersNeedLoad, new QBEntityCallbackImpl<ArrayList<QBUser>>() {
                @Override
    ...
    @Override
    public List<Integer> getOpponents() throws NullPointerException{
    ...
    private class CallServiceConnection implements ServiceConnection {
        ...
        private void login() {
            QBUser qbUser = SharedPrefsHelper.getInstance(CallActivity.this).getQbUser();
