...
public class AudioPlayer {
    ...
    static final String LOG_TAG = Details.TAG_SINCH;
    ...
    public void playRingtone() {
        ...
        switch (audioManager.getRingerMode()) {
            case AudioManager.RINGER_MODE_NORMAL:
                ...
                try {
                    mPlayer.setDataSource(mContext, RingtoneManager.getActualDefaultRingtoneUri(mContext.getApplicationContext(), RingtoneManager.TYPE_RINGTONE));
